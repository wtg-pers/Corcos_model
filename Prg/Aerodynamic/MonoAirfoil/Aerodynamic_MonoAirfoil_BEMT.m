function [flow,geom] = Aerodynamic_MonoAirfoil_BEMT(test,geom,polar,data,method)
...
%%%%%%%%%%%%%calculation of local lift and drag coefficients%%%%%%%%%%%%%%%
        if method.polar == 1
            [Cd_loc,Cl_loc] = Aerodynamic_MonoAirfoil_PolarInterpolation(localAlpha,localReynolds,polar);
        else
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%dlmwrite('./Prg/Aerodynamic/MultiAirfoil/AngleOfAttackSingleAirfoil.dat',flow.AOA);
%
%figure
